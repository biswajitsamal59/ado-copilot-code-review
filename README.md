...
1. Fetches pull request details, file diffs, and linked work item details from Azure DevOps
...
2. **Fetch PR Context**: The task retrieves pull request metadata, file diffs, existing comments, iteration details, and linked work item details via the Azure DevOps REST API.
